window.addEventListener('load', function() {
  ...
  let countUser = document.querySelector('.count-user'),
      ...
      userStep, compStep, countU = 0, sountC = 0, blocked = false;
  ...
  function winner() {
    ...
    switch(comb) {
      ...
      case 'pp':
        res.innerText = 'Ничья!';
        sound.setAttribute('src', 'assets/audio/draw.mp3');
        sound.play();
        break;
      ...
      case 'pr':
        ...
        sound.setAttribute('src', 'assets/audio/win.mp3');
        sound.play();
        countU++;
      ...
      case 'rp':
        ...
        sound.setAttribute('src', 'assets/audio/loss.mp3');
        sound.play();
        countC++;
